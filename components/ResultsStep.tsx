      ...
      <div className="grid lg:grid-cols-12 gap-16 md:gap-24">
        ...
        <div className="lg:col-span-4 space-y-16 pt-2">
          ...
          <div>
            ...
            <p className="text-xl font-normal text-[#111] dark:text-[#EEE] leading-relaxed transition-colors duration-500">
              {result.recommendation}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[#555] dark:text-[#999] text-sm leading-relaxed transition-colors duration-500">
              {result.explanation}
            </p>
          </div>
